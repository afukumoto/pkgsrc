...
--- src/develop/masks/path.c.orig	2022-02-09 10:21:58.000000000 +0000
+++ src/develop/masks/path.c
@@ -2971,13 +2971,9 @@ static int _path_get_mask_roi(const dt_i
...
-#endif
       ...
       {
@@ -3062,13 +3058,9 @@ static int _path_get_mask_roi(const dt_i
     }
