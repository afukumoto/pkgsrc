...
--- src/develop/masks/circle.c.orig	2022-02-09 10:21:58.000000000 +0000
+++ src/develop/masks/circle.c
@@ -1113,13 +1113,9 @@ static int _circle_get_mask_roi(const dt
...
-#endif
   ...
   {
@@ -1213,14 +1209,10 @@ static int _circle_get_mask_roi(const dt
...
@@ -1254,14 +1246,10 @@ static int _circle_get_mask_roi(const dt
...
-#endif
   ...
   for(int j = 0; j < bbh; j++)
     for(int i = 0; i < bbw; i++)
@@ -1288,13 +1276,9 @@ static int _circle_get_mask_roi(const dt
