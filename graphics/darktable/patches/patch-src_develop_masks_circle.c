...
--- src/develop/masks/circle.c.orig	2021-12-04 11:49:09.372924362 +0000
+++ src/develop/masks/circle.c
@@ -1105,13 +1105,9 @@ static int _circle_get_mask_roi(const dt
...
-#endif
   ...
   {
@@ -1205,14 +1201,10 @@ static int _circle_get_mask_roi(const dt
...
@@ -1246,14 +1238,10 @@ static int _circle_get_mask_roi(const dt
...
-#endif
   ...
   for(int j = 0; j < bbh; j++)
     for(int i = 0; i < bbw; i++)
@@ -1280,13 +1268,9 @@ static int _circle_get_mask_roi(const dt
